...
A model to capture CHO dynamics in-silico.
...
- This repo serves as a standalone package, available to install using (or added as a dependency) using:
   ...
   ```
- Accompanying streamlit app available at https://culturebio-insilicho.streamlit.app/
...
.. note::
   ...
   This project is not under active development. If you would like to see improvements of additional features, email simulation@culturebiosciences.com
